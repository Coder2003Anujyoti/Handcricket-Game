...
bo2.addEventListener("click",
  function()
  { window.location.href="file:///storage/emulated/0/IPL%202024/Ipl.html";
  });
...
item.addEventListener('click',function(){ 
 ...
 plname.innerHTML=item.getAttribute("title");
  plimage.innerHTML="<img src='"+item.getAttribute("title")+".webp'>";
  trcb.style.display="none";
...
seplname.style.display="block";
 ...
 if(id==3)
  { 
    dd=["Kohli","Duplesis","Patidar","Jacks","DK","Maxwell","Lomror","Green","Siraj","Ferguson"];
    dd1=[...dd];
    teams.style.display="none";
...
item.addEventListener('click',function(){ 
 ...
 let name=item.getAttribute("src");
  plname.innerHTML=name.substr(0,name.length-5);
 ...
 byus.style.display="block";
  ...
  if(id==0)
  { 
    csk=["Kohli","Duplesis","Patidar","Jacks","DK","Maxwell","Lomror","Green","Siraj","Ferguson"];
    csk1=[...csk];
    teams.style.display="none";
    document.getElementById('tp').style.display="none";
document.getElementById('tc').style.display="block";
...
seplname.style.display="block";
 ...
 pldetails.style.display="none";
  ...
  if(id==3)
  { dd=["Samson","Parag","Jurel","Buttler","Powell","Ashwin","Boult","Chahal","Sandeep","Maharaj"];
    dd1=[...dd];
    teams.style.display="none";
...
item.addEventListener('click',function(){ 
 ...
 byus.style.display="block";
  ...
  if(id==0)
  { csk=["Samson","Parag","Jurel","Buttler","Powell","Ashwin","Boult","Chahal","Sandeep","Maharaj"];
    csk1=[...csk];
    teams.style.display="none";
   trr1.style.display="flex";
  pkk1.style.display="block";
...
document.getElementById('teams').style.display="none";
  ...
  overns.style.display="block";
    ...
    computer.innerHTML="GT(Com)";
    co="GT(Com)"; pk1.innerHTML="Select 10 players-: "+co;
    let ppwi=document.querySelectorAll('#ppwi');
 ppwi.forEach(gh);
   function gh(item)
    { 
...
seplname.style.display="block";
 ...
 pldetails.style.display="none";
  ...
  if(id==3)
  { dd=["Gill","Miller","Wade","Tewatia","Omarzai","Rashid","Shami","Sudarshan","Williamson","Noor Ahmad"];
    dd1=[...dd];
    teams.style.display="none";  
computer.innerHTML="GT(Com)";
    co="GT(Com)"; 
...
item.addEventListener('click',function(){ 
 ...
 byus.style.display="block";
   ...
   if(id==0)
  { csk=["Gill","Miller","Wade","Tewatia","Omarzai","Rashid","Shami","Sudarshan","Williamson","Noor Ahmad"];
    csk1=[...csk];
    teams.style.display="none";  
player.innerHTML="GT(You)";
    pl="GT(You)"; 
...
seplname.style.display="block";
 ...
 if(id==3)
  { dd=["Gaikwad","Conway","Rizvi","Dhoni","Dube","Jadeja","Santner","Shardul","Moeen","Deshpande"];
    dd1=[...dd];
    teams.style.display="none";
 byus.addEventListener('click',function(){
overns.style.display="block";
...
item.addEventListener('click',function(){ 
 ...
 byus.style.display="block";
   ...
   if(id==0)
  { csk=["Gaikwad","Conway","Rizvi","Dhoni","Dube","Jadeja","Santner","Shardul","Moeen","Deshpande"];
    csk1=[...csk];
    teams.style.display="none";
    document.getElementById('tp').style.display="none";
document.getElementById('tc').style.display="block";
...
seplname.style.display="block";
 ...
 pldetails.style.display="none";
  ...
  if(id==3)
  { dd=["Rohit","Tilak","Hardik","Brevis","Romario","Nabi","Gopal","Madhwal","Arjun","Bumrah"];
    dd1=[...dd];
    teams.style.display="none";
   computer.innerHTML="MI(Com)";
    co="MI(Com)";
...
item.addEventListener('click',function(){ 
 ...
 byus.style.display="block";
  ...
  if(id==0)
  { csk=["Rohit","Tilak","Hardik","Brevis","Romario","Nabi","Gopal","Madhwal","Arjun","Bumrah"];
    csk1=[...csk];
    teams.style.display="none";
   player.innerHTML="MI(You)";
    pl="MI(You)";
...
seplname.style.display="block";
 ...
 if(id==3)
  { dd=["Dhawan","Prabhsimran","Bairstow","Livingstone","Shashank","Ashutosh","Brar","Rabada","Arshdeep","Harshal"];
    dd1=[...dd];
    teams.style.display="none";
 computer.innerHTML="PBKS(Com)";
    co="PBKS(Com)";
...
item.addEventListener('click',function(){ 
 ...
 byus.style.display="block";
   ...
   if(id==0)
  { csk=["Dhawan","Prabhsimran","Bairstow","Livingstone","Shashank","Ashutosh","Brar","Rabada","Arshdeep","Harshal"];
    csk1=[...csk];
    teams.style.display="none";
 player.innerHTML="PBKS(You)";
    pl="PBKS(You)";
...
seplname.style.display="block";
 ...
 if(id==3)
  { dd=["Head","Markram","Samad","Klaasen","Jansen","Sundar","Cummins","Umran","Shahbaz","Markande"];
    dd1=[...dd];
    teams.style.display="none";    
  computer.innerHTML="SRH(Com)";
    co="SRH(Com)";
...
item.addEventListener('click',function(){ 
 ...
 byus.style.display="block";
  ...
  if(id==0)
  { csk=["Head","Markram","Samad","Klaasen","Jansen","Sundar","Cummins","Umran","Shahbaz","Markande"];
    csk1=[...csk];
    teams.style.display="none";    
  player.innerHTML="SRH(You)";
    pl="SRH(You)";
...
seplname.style.display="block";
 ...
 pldetails.style.display="none";
  ...
  if(id==3)
  { dd=["Salt","Gurbaz","Rinku","Angkrish","Russell","Harshit","Narine","Starc","Suyash","Ramandeep"];
    dd1=[...dd];
    teams.style.display="none";
  computer.innerHTML="KKR(Com)";
    co="KKR(Com)";
...
item.addEventListener('click',function(){ 
 ...
 byus.style.display="block";
  ...
  if(id==0)
  { csk=["Salt","Gurbaz","Rinku","Angkrish","Russell","Harshit","Narine","Starc","Suyash","Ramandeep"];
    csk1=[...csk];
    teams.style.display="none";
  player.innerHTML="KKR(You)";
    pl="KKR(You)";
...
seplname.style.display="block";
 ...
 if(id==3)
  { dd=["Warner","Pant","Stubbs","Prithvi","Axar","Lalit","Mukesh","Ostwal","Nortje","Kuldeep"];
    dd1=[...dd];
    teams.style.display="none";
  computer.innerHTML="DC(Com)";
    co="DC(Com)";
...
item.addEventListener('click',function(){ 
 ...
 byus.style.display="block";
  ...
  if(id==0)
  { csk=["Warner","Pant","Stubbs","Prithvi","Axar","Lalit","Mukesh","Ostwal","Nortje","Kuldeep"];
    csk1=[...csk];
    teams.style.display="none";
  player.innerHTML="DC(You)";
    pl="DC(You)";
...
document.getElementById('tc').style.display="block";
    teams.style.display="none";
  tlsg.style.display="flex";
  pk.style.display="block";
    
  byu.addEventListener('click',function(){ teams.style.display="block";
    tlsg.style.display="none";
  byu.style.display="none";
  pk.style.display="none";
  });
   document.getElementById('t10').disabled=true;
    player.innerHTML="LSG(You)";
    pl="LSG(You)";
     pk.innerHTML="Select 10 players-: "+pl;
    let pdd=document.querySelectorAll('#plsg');
 pdd.forEach(gh);
   function gh(item)
    { 
...
seplname.style.display="block";
 ...
 if(id==3)
  { dd=["Pooran","Turner","Badoni","Krunal","Stoinis","Shamar","Bishnoi","Mohsin","Hooda","Henry"];
    dd1=[...dd];
    teams.style.display="none";
  computer.innerHTML="LSG(Com)";
    co="LSG(Com)";
    tlsg1.style.display="flex";
  pkk1.style.display="block";
byus.style.display="block";
   pkk1.innerHTML="  Computer team-: "+co;  byus.addEventListener('click',function(){
overns.style.display="block";
tlsg1.style.display="none";
pkk1.style.display="none";
byus.style.display="none";
     imp.style.display="none";
 yes.style.display='none';
  no.style.display='none';
    ...
    let pdd1=document.querySelectorAll('#plsg1');
 pdd1.forEach(gh);
   function gh(item)
    { 
...
item.addEventListener('click',function(){ 
 ...
 byus.style.display="block";
  ...
  if(id==0)
  { csk=["Pooran","Turner","Badoni","Krunal","Stoinis","Shamar","Bishnoi","Mohsin","Hooda","Henry"];
    csk1=[...csk];
    teams.style.display="none";
  player.innerHTML="LSG(You)";
    pl="LSG(You)";
...
p1=document.getElementById('p1');
 ...
 container.style.display="none";
   ...
   let op=csk[j]+"-:"+pp+"("+count+")";
    ...
    pic.innerHTML="<img src='"+csk[j]+".webp'>";
 ...
 var p2=document.getElementById('p2')
  ...
  { wkc++;
    ...
    let op=dd1[j]+"-:"+pc+"("+count+")";
     dev[index]=op;
 container.style.display="none";
    pic.innerHTML="<img src='"+dd1[j]+".webp'>";
    result.style.position="absolute";
 ...
 if(toss==1)
  {
    ...
    { if(totalcount==0 || kanchan==1)
     ...
     if(totalcount==0 || totalcount%6==0)
      ...
      box.innerHTML="<img src='"+csk[k]+".webp' alt=' "+csk[k]+"'>";
box1.innerHTML="<img src='"+dd[j]+".webp' alt=' "+dd[j]+"'>";
      p1.style.display="flex";
      p2.style.display="flex";
  p1.innerHTML="Bat-: "+rp;
 ...
 boc(rp,k,rp,rc,j);
    ...
    { if(totalcount==0 ||kanchan==1)
     ...
     if(totalcount==0 || totalcount%6==0)
      ...
      box.innerHTML="<img src='"+csk1[ki]+".webp' alt=' "+csk1[ki]+"'>";
box1.innerHTML="<img src='"+dd1[ji]+".webp' alt=' "+dd1[ji]+"'>";
      let player1=rp;
    let computer1=rc;
         p1.style.display="flex";
      p2.style.display="flex";
